...
<body><h3>Account No:</h3>
  ...
  "B0 77 BB 25", "Ekhtear Uddin Khan"<br>
    ...
    <form action="insertDB.php" method="post">
        ...
        <nav>
            <label>ID</label>
            <input type="text" name="id" placeholder="id" > </nav>
        <nav>
            <label>Account No:</label>
            <input type="text" name="uAccountNo" placeholder="Account No" > </nav>
        
        <nav>
            <label>Amount: </label>
            <input type="text" name="amount" placeholder="amount" > </nav>
        <nav>
            <label>Time: </label>
            <input type="time" name="time" placeholder="time" > </nav>
        <nav>
            <label>Date: </label>
            <input type="date" name="date" placeholder="date" > </nav>
