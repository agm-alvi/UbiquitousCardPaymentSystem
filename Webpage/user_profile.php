            ...
            <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
                <div class="tab-content">
                   ...
                   // while($resi = mysqli_fetch_array($resultu)) { ?>
                        ...
                        <strong>Thana: <?php echo $resu['thana']; ?></strong>
                        <strong>District: <?php echo $resu['district'];?></strong>
                        <strong>Zip Code: <?php echo $resu['zip_code'];?></strong>
                        <strong>Country: <?php echo $resu['country'];?></strong>        
                    <?php   //}                    ?>
                    </div>
