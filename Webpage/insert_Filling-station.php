            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-7 col-lg-7">
                        <h1>Filling Station Fare Pay</h1>
                        <hr>
                        <form action="insert_filling-station.php" method="post" name="FSForm" id="FSForm">
                            <div class="form-group">
                                <h3>Filling Station ID:
...
include 'connection.php';
	...
	//	$amount = $_POST['amount'];
        ...
        $trx_id = "FS".$wid."-".$res['u_sl']."-".$timestamp;//id for Filling Station (FS)
        echo $res['Balance'];
        echo $bal;
        echo $trx_id;
        $sqlUp = "UPDATE `customers` SET `Balance`='".$bal."' WHERE u_id='".$u_id."'";
        
		$sql1 = "INSERT INTO filling_station (ID, u_id, u_Name, Amount, Date, Time, trx_id) VALUES ('".$wid."','".$u_id."','".$u_name."','".$amountValue."', '".$d."', '".$t."', '".$trx_id."')"; //insert on Filling Station table
