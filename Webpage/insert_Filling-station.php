...
include 'connection.php';
	...
	//	$u_name = $_POST['u_name'];
        ...
        $trx_field = "Filling Station ". $id;//tollbooth
		...
		$sql1 = "INSERT INTO filling_station (ID, u_id, u_Name, Amount, Date, Time, trx_id) VALUES ('".$id."','".$u_id."','".$u_name."','".$amountValue."', '".$d."', '".$t."', '".$trx_id."')"; //insert on toll booth table
