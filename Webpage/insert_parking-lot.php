...
include 'connection.php';
	...
	//	$u_name = $_POST['u_name'];
        ...
        $trx_id = "TB".$wid."-".$res['u_sl']."-".$timestamp;//id for Parking Lot (PL)
        echo $res['Balance'];
        echo $bal;
        echo $trx_id;
        $sqlUp = "UPDATE `customers` SET `Balance`='".$bal."' WHERE u_id='".$u_id."'";
        
		$sql1 = "INSERT INTO toll_booth (ID, u_id, u_Name, Amount, Date, Time, trx_id) VALUES ('".$wid."','".$u_id."','".$u_name."','".$amountValue."', '".$d."', '".$t."', '".$trx_id."')"; //insert on Parking Lot table
