...
//Creates new record as per request
    ...
    if(!empty($_POST['u_id']))
    {
        ...
        $trx_field = "Parking Lot ". $id;
		$sql1 = "INSERT INTO parking_lot (ID, u_id, u_Name, Amount, Date, Time) VALUES ('".$id."','".$u_id."','".$u_name."','".$amountValue."', '".$d."', '".$t."')"; //nodemcu_ldr_table = Youre_table_name
