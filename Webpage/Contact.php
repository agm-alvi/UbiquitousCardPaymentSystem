            ...
            <div class="row">
                ...
                <div class="col-md-6 c_right">
                    <form>
                        ...
                        <h5>Comments*:</h5>
                        <textarea id="" cols="30" rows="10" style="width:100%; color:#fff;" name="comments" required></textarea> <a href="#" class="btn btn-info" role="button" value="Contact Us">Contact Us</a> </form>
                </div>
            </div>
            <div class= "bottom">
                <h2>Find Us</h2>
