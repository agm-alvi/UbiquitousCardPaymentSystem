...
//Creates new record as per request
    ...
    if(!empty($_POST['u_id']))
    {
		...
		$sql1 = "INSERT INTO toll_booth (ID, u_id, u_Name, Amount, Date, Time) VALUES ('".$id."','".$u_id."','".$u_name."','".$amount."', '".$d."', '".$t."')"; //nodemcu_ldr_table = Youre_table_name
        $sql2 = "INSERT INTO transactions (u_id, u_Name, Amount, trx_field, Date, Time) VALUES ('".$u_id."','".$u_name."','".$amount."','".$trx_field."', '".$d."', '".$t."')"; //nodemcu_ldr_table = Youre_table_name
echo "insert";
